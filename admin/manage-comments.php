...
if(strlen($_SESSION['login'])==0)
  { 
    ...
    if($_GET['action']='del'){
        ...
        $id = intval($_GET['id']);
        // Resource Address
        $url = "http://localhost:8088/myNews/api/comment/delete.php?id=$id";
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>AZ News | Manage Comments</title>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            // Get all Comments
                                            $url = "http://localhost:8088/myNews/api/comment/read.php";
                                            $data = consume($url);
                                            
                                            for($i = 0; $i < count($data); $i++){ ?>

                                            <tr>
                                                <td><?php echo htmlentities($data[$i]['article_id']);?></td>
